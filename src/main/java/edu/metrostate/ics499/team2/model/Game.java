...
public abstract class Game {
	...
	public Game(String matchingSymbol, String elementName, String wordSearch, String question, String answers) {
	...
	public String toString() {
		return "Game, GameID=" + GameID + ", matchingSymbol=" + matchingSymbol + ", elementName=" + elementName
